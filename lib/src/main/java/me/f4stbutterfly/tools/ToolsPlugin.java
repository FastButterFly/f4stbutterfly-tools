...
import me.f4stbutterfly.tools.Commands.GamemodeCommand;
...
public class ToolsPlugin extends JavaPlugin {
	...
	public final SmartCommand[] commands = new SmartCommand[] { new TestCommand(this), new GamemodeCommand(this) };
